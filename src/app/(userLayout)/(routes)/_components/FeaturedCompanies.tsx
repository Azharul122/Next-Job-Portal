    ...
    return (
        ...
        <div className='py-10 flex flex-col gap-5'>
            ...
            <div className="flex items-center gap-3 flex-wrap whitespace-nowrap">
                {
                    companies.map(company => <div key={company.id} className="flex items-center gap-2 text-muted-foreground text-sm border dark:border-dark-border border-light-border px-3 py-2">
