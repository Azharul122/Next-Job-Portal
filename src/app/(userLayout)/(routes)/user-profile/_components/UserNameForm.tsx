...
const UserNameForm = ({ userId, initialData,name }: propsTypes) => {
    const [editing, setEditing] = useState(false)
    const form = useForm<z.infer<typeof formSchema>>({
        resolver: zodResolver(formSchema),
        defaultValues: {
            fullName: initialData?.fullName || name || "", // Ensure this is a string
        }
    })
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input disabled={isSubmitting} placeholder="Update fullName" {...field} />
                                        </FormControl>
